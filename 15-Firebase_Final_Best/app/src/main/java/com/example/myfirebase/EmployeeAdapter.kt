...
//    @SuppressLint("ViewHolder")
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val name = view.findViewById<TextView>(R.id.tf1)
        val surname = view.findViewById<TextView>(R.id.tf2)
        val age = view.findViewById<TextView>(R.id.tf3)
        val phone = view.findViewById<TextView>(R.id.tf4)

        val updateBtn = view.findViewById<TextView>(R.id.bt1)
        val deleteBtn = view.findViewById<TextView>(R.id.bt2)
