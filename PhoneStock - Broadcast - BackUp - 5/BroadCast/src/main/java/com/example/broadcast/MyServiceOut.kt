...
class MyServiceOut : Service() {

    override fun onStartCommand(intent: Intent, flags: Int, startId: Int): Int {
        var channel_id = "channel_default"
        channel_id = createChannel()

//        val listActivity = Intent("com.example.phonestock.ADD_PHONE")
        val listActivity = Intent("android.intent.action.L_STOCK")
...
//            .addAction(R.mipmap.ic_launcher, "Open Stock:", pendingIntent)
            .setAutoCancel(true)
            .build()
